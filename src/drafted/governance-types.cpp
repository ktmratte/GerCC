...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "GermanCCNetwork") type = GermanCCNetwork;
    if(strType == "GermanCCNetworkVariable") type = GermanCCNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == GermanCCNetwork) s = "GermanCCNetwork";
    if(type == GermanCCNetworkVariable) s = "GermanCCNetworkVariable";
