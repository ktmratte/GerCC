...
static int AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("GermanCC Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  germancc-cli [options] <command> [params]  " + _("Send command to GermanCC Core") + "\n" +
                  "  germancc-cli [options] help                " + _("List commands") + "\n" +
                  "  germancc-cli [options] help <command>      " + _("Get help for a command") + "\n";
