    ...
    mapper(0)
{
    ...
    ui->theme->addItem(QString("GerCC-light"), QVariant("light"));
    ui->theme->addItem(QString("GerCC-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("GerCC-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("GerCC-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("GerCC-traditional"), QVariant("trad"));
