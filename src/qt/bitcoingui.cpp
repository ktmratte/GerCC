    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("GermanCC Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a GermanCC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and germancc: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About GermanCC Core"), this);
    aboutAction->setStatusTip(tr("Show information about GermanCC Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GermanCC Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GermanCC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GermanCC addresses"));
    ...
    openAction->setStatusTip(tr("Open a germancc: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the GermanCC Core help message to get a list with possible GermanCC Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("GermanCC Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GermanCC network", "", count));
    } else {
...
{
    QString strTitle = tr("GermanCC Core"); // default title
