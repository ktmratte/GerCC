...
#define BOOST_TEST_MODULE GermanCC Test Suite

#include "test_germancc.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_germancc_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
